...
import PropertyParkModal from '@/components/modal/propertyPark'

import { getPropertyParkList, delStaff } from "@/api";
...
export default function SearchPage() {
  ...
  const getDataList = (data) => {
    getPropertyParkList(data).then((res) => {
  ...
  const tableTop = (
    <Row justify="space-between" align="center" gutter={80}>
      <Col style={{ lineHeight: "32px" }}>车位查询</Col>
      <Col>
      ...
      <Spin spinning={load}>
        <div className="top-form">
          <Form layout="inline" form={searchForm}>
            <Form.Item name="parkBm">
              <Input placeholder="输入车位编码" />
            </Form.Item>
